        ...
        <section class="card">
          <div class="grid">
            <div class="field wide"><label for="f_title">Summary<span class="req">*</span></label>
              <input id="f_title" name="title" type="text" value="${esc(title)}" placeholder="${type === "bridge" ? "e.g. CVR102 BRK001 release timer extension" : type === "service" ? "e.g. FDR531 not ramping on startup" : "e.g. Implement multiple under-speed detection methods for CVR061"}" autocomplete="off"></div>
